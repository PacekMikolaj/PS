...
if importlib.util.find_spec("pytest") is not None:
    ...
    def test_merge_characters_and_duplicate():
        assert operations.merge_characters_and_duplicate("abcdefg") == "afafafa"
        assert operations.merge_characters_and_duplicate("12345") == "14141"
        assert operations.merge_characters_and_duplicate("A") == ""
        assert operations.merge_characters_and_duplicate("12") == "11"
        assert operations.merge_characters_and_duplicate("1234") == "1313"
